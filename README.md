...
My current focus is turning scattered ideas, notes, and domain expertise into reusable agent workflows: tools that help research, write, organize knowledge, and keep human review in the loop.

## What I Am Building

- **AI Agent workflows**: task-specific skills, operating procedures, and CLI-assisted automations for repeatable knowledge work.
- **Knowledge systems**: Obsidian-based personal knowledge bases, ontology-driven product prototypes, and structured note pipelines.
